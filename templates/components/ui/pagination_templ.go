		...
		if page.TotalPages > 1 {
			...
			for i := 1; i <= page.TotalPages; i++ {
				if i == page.Page {
					...
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<span class=\"px-1 text-xs text-muted-foreground\">...</span>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				}
