...
func BaseScript(appName string) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_BaseScript_6b35`,
		Function: `function __templ_BaseScript_6b35(appName){document.addEventListener("DOMContentLoaded", () => {
		lucide.createIcons();
	});
	...
	document.addEventListener("alpine:init", () => {
		...
		Call:       templ.SafeScript(`__templ_BaseScript_6b35`, appName),
		CallInline: templ.SafeScriptInline(`__templ_BaseScript_6b35`, appName),
	}
}
